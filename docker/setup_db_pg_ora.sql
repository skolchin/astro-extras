...
values
	('source_db','oracle', NULL, NULL, NULL, 'airflow', '9am_27ab61', 1521, false, false,
		'{"dsn": "(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=oracle-db)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=FREEPDB1)))"}'
    ),
